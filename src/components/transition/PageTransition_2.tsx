...
export default function PageTransition2({
  onCenter,
  onComplete,
  bgCharSrc = "/assets/images/cat_hero_1.webp", // fallback default
  fgCharSrc = "/assets/images/cat_hero_1.webp", // fallback default
}: PageTransitionProps) {
          ...
          <div className="relative w-full h-full pointer-events-auto">
            ...
            >
              ...
              <div
                ...
                style={{
                  backgroundImage:
                    "linear-gradient(135deg,#1e3a8a_25%,transparent_25%,transparent_50%,#1e3a8a_50%,#1e3a8a_75%,transparent_75%,transparent)",
            ...
            <motion.div
              ...
              style={{
                clipPath: "polygon(75% 0, 100% 0, 100% 100%, 52% 100%)",
              }}
            >
            ...
            <div className="absolute inset-0 z-50 flex items-end justify-center pointer-events-none select-none">
              <motion.div
                ...
                animate="animate"
                exit="exit"
                className=" flex items-center justify-center" // relative w-[90vw] max-w-137.5 h-[85vh] md:h-[90vh] origin-bottom mb-[-2vh]
              >
                <Image
                  src={fgCharSrc}
                  ...
                  height={320}
                  priority
                  className="w-auto h-auto object-contain object-center drop-shadow-[0_25px_35px_rgba(0,0,0,0.5)]"
                  draggable={false}
                />
              </motion.div>
            </div>
